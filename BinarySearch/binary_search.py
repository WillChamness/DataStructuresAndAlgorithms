def binary_search(sorted_list, target, recursive=True):
    """
    ...
    if recursive:
        return _binary_search_rec(sorted_list, target, 0, len(sorted_list) - 1)
    else:
        return _binary_search(sorted_list, target)
